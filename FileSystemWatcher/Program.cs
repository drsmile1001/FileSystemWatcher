...
namespace FileSystemWatcher
{
    class Program
    {
        ...
        {
            Console.WriteLine($"{DateTime.Now:yy-MM-dd HH:mm:ss} [Renamed] {renamedEventArgs.OldFullPath} -> {renamedEventArgs.FullPath}");
        }

        private static void OnChanged(object sender, FileSystemEventArgs eventArgs)
        {
            Console.WriteLine($"{DateTime.Now:yy-MM-dd HH:mm:ss} [{eventArgs.ChangeType}] {eventArgs.FullPath}");
        }
    }
}
